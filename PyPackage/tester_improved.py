...
# create new playlist
playlist = sp.user_playlist_create(sp.me()['id'], name="Mixerify " + current + " AI Remix", description=("Top 50 new \
songs generated by the mixerify AI model as a remix for " + current))
with open(Path(URL_MODIFIER + "./user_playlists/Playlist_pic.jpg"), "rb") as image_file:
...
df = pd.read_pickle(URL_MODIFIER + "./model_pkls/dataset.pkl")
...
# we are not using this variable lol
