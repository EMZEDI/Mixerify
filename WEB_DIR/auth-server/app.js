...
app.get("/login", function (req, res) {
  ...
  var scope = "ugc-image-upload user-read-private user-library-modify playlist-modify-public user-library-read playlist-read-private playlist-read-collaborative";
  res.redirect(
